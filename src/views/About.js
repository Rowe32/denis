...
const About = () => {
  ...
  return (
    <section className="middleSection" ref={aboutRef} id="aboutContainer">
      <img src={DenisAtBar} alt="denis at the bar" />
      <div>
        <h3>ABOUT</h3>
        <p>
          Hi! My name is Denis Fröbel and I am a professional barkeeper with
          more than ten years experience working in bars, clubs, at festivals
          and private events.
        </p>
      </div>
    </section>
