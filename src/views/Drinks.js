...
const Drinks = () => {
    ...
    useEffect(()=>{
        ...
        if (
            subIndex === words[index].length + 1 && /** subindex = currents word lenght + 1 - word is typed */
        ...
        if (subIndex === 0 && reverse) { /* word was deleted & reverse true*/
        ...
        const timeout = setTimeout(() => {
            setSubIndex((prev) => prev + (reverse ? -1 : 1 )); /* change speed depending on reverse is true or false */
